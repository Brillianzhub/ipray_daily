    ...
    return (
        <View className='bg-white justify-center p-4'>
            ...
            >
                ...
                <Text className='text-lg my-2 text-center'>{posts[state.currentSlide].text}</Text>
                <Text className='text-center text-orange-400 text-xl mt-3 italic mb-3'>{posts[state.currentSlide].bible_verse}</Text>

        ...
        <SafeAreaView className="flex bg-white">
            <View className="w-full mt-10 justify-center">
                ...
                <TextInput
                    ...
                    className="mb-4 border border-sky-600 rounded-xl h-12 text-xl p-3 mt-4"
                />

                <View className="flex-row justify-center  mb-6 mt-2 px-1">
                    <TouchableOpacity onPress={() => setModalVisible(true)} className="bg-orange-50 justify-center w-1/2 h-12 border mr-2 border-solid border-orange-400 p-2 rounded-xl">
                        <Text className="text-black font-bold text-center text-xl">Select Group</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={addEmail} className="bg-orange-50 justify-center w-1/2 h-12 border border-solid border-orange-400 p-2 rounded-xl">

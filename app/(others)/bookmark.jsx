...
import { View, Text, FlatList, StyleSheet, ActivityIndicator, TouchableOpacity, Image, Alert, Share } from 'react-native';
...
const BookmarkedScreen = () => {
            ...
            [
                ...
                },
                {
                    ...
                    onPress: () => {
                        ...
                        setVisibleDropdown(null); // Hide the dropdown menu after removing
                    }
                }
            ]
        );
                ...
                const fetchedData = await Promise.all(
                    Object.keys(highlightColors).map(async (id) => {
                        ...
                        return {
                            id,
                            ...verse,
                            book: chapter?.book?.name || 'Unknown Book', // Ensure proper access to the book name
                            chapter: chapter?.number || 'Unknown Chapter', // Ensure chapter is not undefined
    ...
    const renderListContent = () => {
        ...
        const filteredData = activeCategory === 'Bible' ? fetchedVerses : []; // For now, prayers list is empty
        ...
        return (
            <FlatList
                ...
                renderItem={({ item }) => (
                    <View style={[styles.verseContainer, { backgroundColor: item.color }]}>
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                <TouchableOpacity onPress={() => navigateTo('/home')} style={styles.iconContainer}>
                    <Image source={icons.back} style={styles.icon} resizeMethod="contain" />
                </TouchableOpacity>
                <Text style={styles.title}>Bookmarked List</Text>
                <View style={styles.iconPlaceholder} />
            </View>
            <View className="flex-row justify-between mt-12 pt-8 mb-2">
                <TouchableOpacity

            ...
            <ScrollView className="bg-white h-full">
                <View className="flex-col my-6 p-4 min-h-[95vh]">
                    ...
                    <View className="flex justify-center">
                        ...
                        {showContentAboutApp && (
                            <>
                                ...
                                <Text className="text-base leading-loose mb-4">
                                ...
                                <Text className="text-base leading-loose mb-8">
                                ...
                                <View className="flex-row items-center mb-4">
                                    <Text className="text-lg text-orange-400 mr-2">Discover daily inspiration:{" "}
                                ...
                                <View className="flex-row items-center mb-4">
                                    <Text className="text-lg text-orange-400 mr-2">Find prayers for every occasion:{" "}
                                        <Text className="text-base text-black w-full font-normal">
                    ...
                    <View className="flex justify-center mb-8">
                        ...
                        {showContentJoinUs && (
                            <>
                                <Text className="text-base text-left mt-2">
